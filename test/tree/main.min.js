	    ...
	    _createClass(TreeDiagram, [{
	        ...
	        value: function draw(config) {
	            ...
	            var angel = this.canvasInfo.angel,
	                cx = this.canvasInfo.centerX,
	                cy = this.canvasInfo.centerY,
	                data = _Calcu2.default.layoutNode(this.store.getExpendData(), config),
	                nodes = data.nodes,
	                links = data.links;
	            // 清空
	            angel.clear();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Calcu = function () {
	    ...
	    _createClass(Calcu, [{
	        key: 'layoutNode',
	        value: function layoutNode(data, config) {
	            // 布局计算
	            if (!config) {
	    ...
	    _createClass(Store, [{
	        ...
	        value: function _dataFormat(nodes, links) {
	            ...
	            links.forEach(function (link) {
	                ...
	                if (!_this2.linkMap[key]) {
	                    ...
	                    _this2.linkMap[key] = Object.assign({
	                        fromNode: from,
	                        toNode: to
	                    }, link);
	                    if (from.type === 'parent') {
	        ...
	        value: function _nodeStyleMixin() {
	            ...
	            this.iteratorNode(function (node, i) {
	                ...
	                Object.assign(_this3.nodeMap[node.id], newAttr);
	            });
	        }
	    }, {
	        key: '_linkStyleMixin',
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    topLevelColors: ['rgba(255, 100, 0, 1)', 'rgba(230, 150, 0, 1)', 'rgba(205, 0, 0, 1)', 'rgba(180, 0, 0, 1)', 'rgba(155, 0, 0, 1)', 'rgba(130, 0, 0, 1)', 'rgba(105, 0, 0, 1)', 'rgba(80, 0, 0, 1)', 'rgba(55, 0, 0, 1)', 'rgba(30, 0, 0, 1)'], // 第一层树节点颜色序列
	    topLevelBorderColors: ['rgba(255, 100, 0, 1)', 'rgba(230, 150, 0, 1)', 'rgba(205, 0, 0, 1)', 'rgba(180, 0, 0, 1)', 'rgba(155, 0, 0, 1)', 'rgba(130, 0, 0, 1)', 'rgba(105, 0, 0, 1)', 'rgba(80, 0, 0, 1)', 'rgba(55, 0, 0, 1)', 'rgba(30, 0, 0, 1)'], // 第一层树节点边框颜色
	    fontColor: '#666', // 字体颜色
	    fontSize: 14,
	    fontFamily: 'Verdana',
