	    ...
	    _createClass(TreeDiagram, [{
	        ...
	        value: function animation(staticNode) {
	            ...
	            var angel = this.canvasInfo.angel,
	                ...
	                data = staticNode ? _Calcu2.default.layoutNodeByDagre(this.store.getExpendData(), staticNode) : _Calcu2.default.layoutNode(this.store.getExpendData(), this.store.root),
	                nodes = data.nodes,
	                links = data.links,
	                animationSpend = 200,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Calcu = function () {
	    ...
	    _createClass(Calcu, [{
	        key: 'layoutNode',
	        value: function layoutNode(data, centerNode) {
	            // 以centerNode为中心点布局
	        ...
	        value: function layoutNodeByDagre(data, staticNode) {
	            // 节点布局计算
